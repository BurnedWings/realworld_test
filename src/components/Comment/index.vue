            ...
            <div class="reply-item" v-for="(reply,index) in comment.replyList" :key="reply._id">
              ...
              <div class="reply-right">
                ...
                <div class="reply-item-bottom">
                  ...
                  <div
                    @click="showReplyInput(myIndex,reply.user,reply.user._id,comment._id,comment.article)"
                    class="reply"
                  >回复</div>
...
export default {
  ...
  methods: {
    //显示回复输入框
    showReplyInput(index, user, replyId, commentId, articleId) {
      ...
      setTimeout(() => {
        this.$bus.$emit("myFocus", user, articleId, commentId, replyId);
      }, 50);
    },
    //回复点赞
